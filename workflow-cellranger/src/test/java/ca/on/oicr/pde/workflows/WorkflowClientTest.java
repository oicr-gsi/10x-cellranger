...
public class WorkflowClientTest {
    ...
    private final String defaultInput = "1,100,NoIndex,101,Sample_Name+"
            + "3,107,AAAGTG,108,Sample_Name+3,107,AAAGTC,109,Sample_Name+3,107,AAAGTC,110,Sample_Name+"
            + "2,103,TTTGTG,104,Sample_Name+2,103,ATTGTC,105,Sample_Name+2,103,AATGTG,106,Sample_Name";
    ...
    public void getLaneNumbers() {
        ...
        String input = "1,100,NoIndex,101,Sample_Name+1,100,AAAGTC,102,Sample_Name+"
                + "3,107,NoIndex,108,Sample_Name+3,107,AAAGTC,109,Sample_Name+3,107,NoIndex,110,Sample_Name+"
                + "3,107,NoIndex,111,Sample_Name+3,107,AAAGTC,112,Sample_Name+3,107,NoIndex,113,Sample_Name+"
                + "2,103,NoIndex,104,Sample_Name+2,103,AAAGTC,105,Sample_Name+2,103,NoIndex,106,Sample_Name";
    ...
    public void getLaneListFromLaneNumber() {
        ...
        String input = "1,100,NoIndex,101,Sample_Name+1,100,AAAGTC,102,Sample_Name+"
                + "2,103,NoIndex,104,Sample_Name+2,103,AAAGTC,105,Sample_Name+2,103,NoIndex,106,Sample_Name+"
                + "1,100,NoIndex,107,Sample_Name+1,100,AAAGTC,108,Sample_Name";
    ...
    public void getBarcodeStringFromLaneList() {
        ...
        String input = "1,100,NoIndex,101,Sample_Name+1,100,AAAGTC,102,Sample_Name+"
                + "2,103,NoIndex,104,Sample_Name+2,103,AAAGTC,105,Sample_Name+2,103,NoIndex,106,Sample_Name+"
                + "1,100,NoIndex,107,Sample_Name+1,100,AAAGTC,108,Sample_Name";
        String expected = "1,NoIndex,101,Sample_Name_NoGroup+1,AAAGTC,102,Sample_Name_NoGroup+1,NoIndex,107,Sample_Name_NoGroup+1,AAAGTC,108,Sample_Name_NoGroup";
    ...
    public void parseGroupIdFromString() {
        ...
        for (int i = 0; i < barcodes.length; i++) {
            input += "1,100," + barcodes[i] + "," + ius[i] + "," + sampleName + "," + groupId[i];
    ...
    public void testGetOutputPath() {
        ...
        String actual = WorkflowClient.getOutputPath(flowcell, laneNum, iusSwAccession, sampleName, barcode, read, groupId, sampleSheetRowNumber);
        Assert.assertEquals(actual, expected);
    ...
    public void validateRegressionTestDefinition() throws IllegalAccessException, InstantiationException, IOException, Exception {
        ...
        for (TestDefinition.Test t : td.getTests()) {
            DryRun<WorkflowClient> d = new DryRun<>(System.getProperty("bundleDirectory"), t.getParameters(), WorkflowClient.class);
